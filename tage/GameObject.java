...
public class GameObject
{
	...
	*/
	...
	/** Forward Action */
	public void fwdAction(float speed) {
		oldPosition = getWorldLocation();
		fwdDirection = new Vector4f(0f, 0f, 1f, 1f);
		fwdDirection.mul(getWorldRotation());
	...
	/** Backward Action */
	public void bwdAction(float speed) {
		oldPosition = getWorldLocation();
		fwdDirection = new Vector4f(0f, 0f, 1f, 1f);
		fwdDirection.mul(getWorldRotation());
		fwdDirection.mul(-speed);
	...
	/** Left Action */
	public void leftAction(float speed) {
		oldPosition = getWorldLocation();
	...
	/** Right Action */
	public void rightAction(float speed) {
		oldPosition = getWorldLocation();
		fwdDirection = new Vector4f(1f, 0f, 0f, 1f);
		fwdDirection.mul(getWorldRotation());
		fwdDirection.mul(-speed);
	...
	/** Turn Right Action */
	public void turnRightAction(float speed) {
		oldRotation = new Matrix4f(getWorldRotation());
		oldUp = new Vector4f(0f,getWorldUpVector().y,0f,1f).mul(oldRotation);
		rotAroundAvatarUp = new Matrix4f().rotation(-speed,
	...
	/** Turn Left Action */
	public void turnLeftAction(float speed) {
		oldRotation = new Matrix4f(getWorldRotation());
		oldUp = new Vector4f(0f,getWorldUpVector().y,0f,1f).mul(oldRotation);
		rotAroundAvatarUp = new Matrix4f().rotation(speed,
				new Vector3f(oldUp.x(), oldUp.y(), oldUp.z()));
	...
	public void rotateUpAction() {
		...
		rotAroundAvatarUp = new Matrix4f().rotationX(-.005f);
		newRotation = oldRotation;
		newRotation.mul(rotAroundAvatarUp);
		setLocalRotation(newRotation);
	}
